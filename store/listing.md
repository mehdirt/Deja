...
>
> Deja is a local-first prompt library. It saves the prompts you send to
> ChatGPT, Claude, Gemini, DeepSeek, and Grok, makes them searchable, and
> resurfaces the right one while you're typing the next.
>
> ▸ AUTOMATIC CAPTURE
> No copy-paste, no buttons. Prompts you send are saved when you submit them —
> across all five tools. Multi-line prompts and code blocks keep their
> formatting. Exact and near-duplicate submits collapse into one entry.
>
> ▸ "YOU'VE BEEN HERE BEFORE"
> As you type, Deja reminds you when you've asked something similar before,
> shows why it matched, and lets you step through past versions. Click to
> copy — it never types into the box unless you opt in.
>
...
> settings (off / balanced / strict).
>
> ▸ YOURS TO CONTROL
> Pause with one click, switch off any site, or auto-pause in incognito.
> Detected personal info (emails, phone numbers, cards, keys) is replaced with
> labels like [email] before saving — locally, on by default, tunable.
>
> ▸ YOURS TO KEEP
> Download a backup or a readable document, restore later, never-save rules for
> sites or patterns, wipe everything in one click.
>
> ▸ PRIVATE BY DESIGN
> Deja makes no network calls. No telemetry, no analytics, no accounts, no cloud.
> Everything lives in your browser. It saves only the prompt text you type —
> never the AI's replies — and never reads password, one-time-code, or payment
> fields.
>
