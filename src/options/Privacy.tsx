...
const DOES = [
  ...
  'Swaps personal details it recognises — emails, phone numbers, card numbers, passwords and keys — for placeholders like [email_1] before anything is saved. On by default. Optionally remembers the real values in a private list on this computer for fill-in only — never in a backup.',
